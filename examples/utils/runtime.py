...
class cudaDeviceProp(_Structure):
  _fields_ = [('name', ctypes.c_char * 256), ('uuid', CUuuid), ('luid', ctypes.c_char * 8), ('luidDeviceNodeMask', ctypes.c_uint),
              ('totalGlobalMem', ctypes.c_ulong), ('sharedMemPerBlock', ctypes.c_ulong), ('regsPerBlock', ctypes.c_int), ('warpSize', ctypes.c_int),
              ('memPitch', ctypes.c_ulong), ('maxThreadsPerBlock', ctypes.c_int), ('maxThreadsDim', ctypes.c_int * 3), ('maxGridSize', ctypes.c_int * 3),
              ('clockRate', ctypes.c_int), ('totalConstMem', ctypes.c_ulong), ('major', ctypes.c_int), ('minor', ctypes.c_int), 
              ('textureAlignment', ctypes.c_ulong), ('texturePitchAlignment', ctypes.c_ulong), ('deviceOverlap', ctypes.c_int),
              ('multiProcessorCount', ctypes.c_int), ('kernelExecTimeoutEnabled', ctypes.c_int), ('integrated', ctypes.c_int),
              ('canMapHostMemory', ctypes.c_int), ('computeMode', ctypes.c_int), ('maxTexture1D', ctypes.c_int), ('maxTexture1DMipmap', ctypes.c_int),
              ('maxTexture1DLinear', ctypes.c_int), ('maxTexture2D', ctypes.c_int * 2), ('maxTexture2DMipmap', ctypes.c_int * 2),
              ('maxTexture2DLinear', ctypes.c_int * 3), ('maxTexture2DGather', ctypes.c_int * 2), ('maxTexture3D', ctypes.c_int * 3),
              ('maxTexture3DAlt', ctypes.c_int * 3), ('maxTextureCubemap', ctypes.c_int), ('maxTexture1DLayered', ctypes.c_int * 2),
              ('maxTexture2DLayered', ctypes.c_int * 3), ('maxTextureCubemapLayered', ctypes.c_int * 2), ('maxSurface1D', ctypes.c_int),
              ('maxSurface2D', ctypes.c_int * 2), ('maxSurface3D', ctypes.c_int * 3), ('maxSurface1DLayered', ctypes.c_int * 2),
              ('maxSurface2DLayered', ctypes.c_int * 3), ('maxSurfaceCubemap', ctypes.c_int), ('maxSurfaceCubemapLayered', ctypes.c_int * 2),
              ('surfaceAlignment', ctypes.c_ulong), ('concurrentKernels', ctypes.c_int), ('ECCEnabled', ctypes.c_int), ('pciBusID', ctypes.c_int),
              ('pciDeviceID', ctypes.c_int), ('pciDomainID', ctypes.c_int), ('tccDriver', ctypes.c_int), ('asyncEngineCount', ctypes.c_int),
              ('unifiedAddressing', ctypes.c_int), ('memoryClockRate', ctypes.c_int), ('memoryBusWidth', ctypes.c_int), ('l2CacheSize', ctypes.c_int),
              ('maxThreadsPerMultiProcessor', ctypes.c_int), ('streamPrioritiesSupported', ctypes.c_int), ('globalL1CacheSupported', ctypes.c_int),
              ('localL1CacheSupported', ctypes.c_int), ('sharedMemPerMultiprocessor', ctypes.c_ulong), ('regsPerMultiprocessor', ctypes.c_int),
              ('managedMemory', ctypes.c_int), ('isMultiGpuBoard', ctypes.c_int), ('multiGpuBoardGroupID', ctypes.c_int),
              ('hostNativeAtomicSupported', ctypes.c_int), ('singleToDoublePrecisionPerfRatio', ctypes.c_int), ('pageableMemoryAccess', ctypes.c_int),
              ('concurrentManagedAccess', ctypes.c_int), ('computePreemptionSupported', ctypes.c_int), ('canUseHostPointerForRegisteredMem', ctypes.c_int),
              ('cooperativeLaunch', ctypes.c_int), ('cooperativeMultiDeviceLaunch', ctypes.c_int), ('sharedMemPerBlockOptin', ctypes.c_ulong),
              ('pageableMemoryAccessUsesHostPageTables', ctypes.c_int), ('directManagedMemAccessFromHost', ctypes.c_int)]
